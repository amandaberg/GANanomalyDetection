...
train       = EasyDict(func='train.train_progressive_gan')#, resume_run_id=58, resume_kimg=3246)  # Options for main training func.
...
#train = EasyDict(func='util_scripts.generate_training_video', run_id=3, duration_sec=60.0); num_gpus = 1; desc = 'training-video-' + str(train.run_id)
